...
VL_ATTR_COLD void Vbitrev_tb___024root___ctor_var_reset(Vbitrev_tb___024root* vlSelf) {
    ...
    vlSelf->bitrev_tb__DOT____Vlvbound_h6ebd1da0__0 = VL_RAND_RESET_I(1);
    for (int __Vi0 = 0; __Vi0 < 2048; ++__Vi0) {
        vlSelf->bitrev_tb__DOT__dut__DOT__sram[__Vi0] = VL_RAND_RESET_I(32);
    }
    ...
    vlSelf->bitrev_tb__DOT__dut__DOT__wr_cnt = VL_RAND_RESET_I(10);
    vlSelf->bitrev_tb__DOT__dut__DOT__rd_cnt = VL_RAND_RESET_I(10);
    vlSelf->bitrev_tb__DOT__dut__DOT__wr_cnt_next = VL_RAND_RESET_I(10);
    vlSelf->bitrev_tb__DOT__dut__DOT__data_q = VL_RAND_RESET_I(32);
    vlSelf->bitrev_tb__DOT__dut__DOT__rev_addr = VL_RAND_RESET_I(10);
    vlSelf->bitrev_tb__DOT__dut__DOT__data_d = VL_RAND_RESET_I(32);
    vlSelf->__Vfunc_bitrev_tb__DOT__dut__DOT__bit_reverse__2__Vfuncout = VL_RAND_RESET_I(10);

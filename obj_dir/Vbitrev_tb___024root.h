...
class alignas(VL_CACHE_LINE_BYTES) Vbitrev_tb___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ bitrev_tb__DOT____Vlvbound_h6ebd1da0__0;
    ...
    SData/*9:0*/ bitrev_tb__DOT__dut__DOT__wr_cnt;
    SData/*9:0*/ bitrev_tb__DOT__dut__DOT__rd_cnt;
    SData/*9:0*/ bitrev_tb__DOT__dut__DOT__wr_cnt_next;
    SData/*9:0*/ bitrev_tb__DOT__dut__DOT__rev_addr;
    SData/*9:0*/ __Vfunc_bitrev_tb__DOT__dut__DOT__bit_reverse__2__Vfuncout;
    ...
    VlUnpacked<IData/*31:0*/, 2048> bitrev_tb__DOT__dut__DOT__sram;
